...
@section('title', 'Edit Pembeli Padi')
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Edit Pembeli Padi</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Edit Pembeli Padi</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.buyer.update', [$buyer]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" value="{{ $buyer->price }}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="" class="form-control" required
                                    ...
                                    oninput="setCustomValidity('')">{{ $buyer->description }}</textarea>
                            </div>
