            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>Nama:</label>
                        <input type="text" name="name" value="{{ $farmer->name }}" class="form-control" required
                    ...
                    <div class="form-group">
                        <label>No HP:</label>
                        <input type="text" name="phone" value="{{ $farmer->phone }}" class="form-control" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="land_area" value="{{ $farmer->land_area }}" class="form-control"
                            required oninvalid="this.setCustomValidity('Masukan Luas Lahan!')"
