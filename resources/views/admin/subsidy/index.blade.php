                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.subsidy.show', [$subsidy]) }}" class="dropdown-item"><i class="icon-eye"></i>Show</a>
                                        <a href="{{ route('admin.subsidy.edit', [$subsidy]) }}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
                                        <button class="dropdown-item" onclick="hapus({{ $subsidy->id }})"><i class="icon-bin"></i> Delete</button>
                                    </div>
                                </div>
                            </div>
                        </td>
