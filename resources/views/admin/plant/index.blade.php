...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-item active">Jadwal Menanam</span>
        </div>
    </div>
</div>
@endsection
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h5 class="card-title">Data Jadwal Menanam</h5>
            <div class="header-elements">
                <div class="list-icons">
                    <a class="list-icons-item" data-action="collapse"></a>
                    <a class="list-icons-item" data-action="reload"></a>
                    <a href="{{ route('admin.plant.create') }}" class="btn btn-primary text-white">Tambah Data</a>
                </div>
            </div>
        </div>
        <table class="table text-nowrap table-customers">
            <thead>
                <tr>
                    ...
                    <th>Periode</th>
                    <th>Type Jadwal</th>
                    <th>Batas Tgl Awal</th>
                    <th>Batas Tgl Akhir</th>
                    <th>Deskripsi</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $agenda->type == 1 ? 'Jadwal Menanam': 'Jadwal Meeting' }}</td>
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('admin.plant.edit', [$agenda]) }}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
...
@section('script')
    <script>
        ...
        if(yakin) {
            window.location = "{{ url('/') }}" + "/admin/menanam/delete/" + id;

        }else{
            window.location = "{{ url('/') }}" + "/admin/menanam";
        }
    }
    </script>
@endsection
