                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ asset('/storage' . $tool->image) }}" data-popup="lightbox">
                                    <img style="width: 100px;" src="{{ asset('/storage' . $tool->image) }}" alt=""
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('admin.tool.edit', [$tool]) }}" class="dropdown-item"><i
                                                    class="icon-pencil7"></i>Edit</a>
                                            <button class="dropdown-item" onclick="hapus({{ $tool->id_tool }})"><i
...
@section('script')
    <script>
        function hapus(id_tool) {
            var yakin = confirm('Yakin Hapus Data?');
            if (yakin) {
                window.location = "{{ url('/') }}" + "/admin/alat/delete/" + id_tool;
