                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.tool.update', [$tool]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $tool->name }}" name="name" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan Nama Alat !')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Merk:</label>
                                <input type="text" value="{{ $tool->merk }}" name="merk" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan Merk !')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Harga Jasa / are:</label>
                                <input type="number" value="{{ $tool->price }}" name="price" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" value="" id="" class="form-control" required
                                    ...
                                    oninput="setCustomValidity('')">{{ $tool->description }}</textarea>
                            </div>
