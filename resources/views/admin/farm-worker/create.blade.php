...
@section('title', 'Tambah Buruh Tani')
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Tambah Buruh Tani</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Tambah Buruh Tani</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.farm-worker.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="service_name" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan nama jasa!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Harga Jasa:</label>
                                <input type="number" name="price" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan harga jasa!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>No HP:</label>
