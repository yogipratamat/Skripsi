        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.meeting.update', [$meeting->id_meeting]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" value="{{ $meeting->date }}" class="form-control"
                                    required oninvalid="this.setCustomValidity('Masukan Tanggal!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Waktu:</label>
                                <input type="time" name="time" value="{{ $meeting->time }}" class="form-control"
                                    required oninvalid="this.setCustomValidity('Masukan Waktu!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Tempat:</label>
                                <input type="text" name="place" value="{{ $meeting->place }}" class="form-control"
                                    required oninvalid="this.setCustomValidity('Masukan Tempat!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="description" id="" class="form-control" required
                                    ...
                                    oninput="setCustomValidity('')">{{ $meeting->description }}</textarea>
                            </div>
