...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-item active">Laporan Penyewaan Alat</span>
        </div>
    </div>
</div>
@endsection
            ...
            <form action="{{ route('admin.report.index') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            <select class="form-control" name="farmer" required oninvalid="this.setCustomValidity('Masukan Kelompok Tani !')" oninput="setCustomValidity('')">
