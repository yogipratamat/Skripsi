...
@section('title', 'Tambah Jasa Pertanian')
...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-item active">Tambah Jasa Pertanian</span>
        </div>
    </div>
</div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Tambah Jasa Pertanian</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="service_name" class="form-control" required oninvalid="this.setCustomValidity('Masukan Nama Jasa!')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Harga Jasa:</label>
                                <input type="text" name="price" class="form-control" required oninvalid="this.setCustomValidity('Masukan Harga!')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>No HP:</label>
