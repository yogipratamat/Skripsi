        ...
        <div class="card-header bg-white header-elements-inline">
            ...
            <div class="header-elements">
                <div class="list-icons">
                    ...
                    <a href="{{ route('penyuluh.product.create') }}" class="btn btn-primary text-white">Tambah Data</a>
                </div>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ asset('/storage' . $product->image) }}" data-popup="lightbox">
                            <img style="width: 100px;" src="{{ asset('/storage' . $product->image) }}" alt="" class="img-preview rounded">
                        </a>
                    </td>
                    <td>{{ $product->name }}</td>
                    <td>{{ $product->merk }}</td>
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('penyuluh.product.edit',[$product]) }}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
                                    <button class="dropdown-item" onclick="hapus({{ $product->id }})"><i class="icon-bin"></i> Delete</button>
                                </div>
                            </div>
                        </div>
                    </td>
