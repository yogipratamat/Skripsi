...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <a href="{{ route('penyuluh.product.index') }}" class="breadcrumb-item">Pestisia</a>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('penyuluh.product.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>Nama:</label>
                                <input type="text" name="name" class="form-control" required oninvalid="this.setCustomValidity('Masukan Produksi !')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Merk:</label>
                                <input type="text" name="merk" class="form-control" required oninvalid="this.setCustomValidity('Masukan Merk !')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Harga:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="stock" class="form-control" required oninvalid="this.setCustomValidity('Masukan Stok !')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
