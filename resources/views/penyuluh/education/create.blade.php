        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('penyuluh.education.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan nama penyakit!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Ciri-Ciri:</label>
                                <input type="text" name="ciri" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan Ciri-Ciri!')"
                                    oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <label>Solusi:</label>
                                <textarea name="solution" id="" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan Solusi!')"
