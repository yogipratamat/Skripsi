...
<div class="content">
    ...
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h5 class="card-title">Data Edukasi & Pengendalian</h5>
            <div class="header-elements">
                <div class="list-icons">
                    <a class="list-icons-item" data-action="collapse"></a>
                    <a class="list-icons-item" data-action="reload"></a>
                    <a href="{{ route('penyuluh.education.create') }}" class="btn btn-primary text-white">Tambah Data</a>
                </div>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ asset('/storage' . $education->image) }}" data-popup="lightbox">
                            <img style="width: 100px;" src="{{ asset('/storage' . $education->image) }}" alt="" class="img-preview rounded">
                        </a>
                    </td>
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('penyuluh.education.edit', [$education]) }}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
                                    <button class="dropdown-item" onclick="hapus({{ $education->id }})"><i class="icon-bin"></i> Delete</button>
                                </div>
                            </div>
                        </div>
                    </td>
...
@section('script')
    <script>
        ...
        if(yakin) {
            window.location = "{{ url('/') }}" + "/penyuluh/edukasi/delete/" + id;
