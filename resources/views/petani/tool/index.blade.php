                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <ul class="list-inline list-inline-dotted text-muted mb-0">
                                    <li class="list-inline-item">Merk: <a href="#" class="text-muted">{{ $tool->merk }}</a></li>
                        ...
                        <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
                            <div class="mt-2 mt-sm-0">
                                <a href="{{ route('petani.tool.show', [$tool->id]) }}"><button class="btn btn-outline-success">Detail</button></a>
                            </div>
                        </div>
                    </div>
                </div>
