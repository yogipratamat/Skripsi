        ...
        <div class="card">
            <div class="row">
                <div class="col-md-8 cart">
                            ...
                            <div class="row border-top border-bottom">
                                <div class="row main align-items-center">
                                    <div class="col-2"><img class="img-fluid"
                                            src="{{ asset('/storage' . $cart['image']) }}"></div>
                                    <div class="col">
                                        <div class="row text-muted">{{ $cart['name'] }}</div>
                                    </div>
                                    <div class="col">{{ $cart['qty'] }}</div>

                                    <div class="col">Rp. {{ number_format($cart['price'], 2, ',', '.') }}
                                    </div>
                    ...
                    @endif
                    <div class="back-to-shop"><a href="{{ route('petani.product.index') }}">&leftarrow;</a><span
                ...
                <div class="col-md-4 summary">
                    ...
                    </div> <a href="{{ route('petani.cart.checkout') }}"><button
