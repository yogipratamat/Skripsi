    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Tambah Galery Foto</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title">Tambah Galery Foto</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('petani.galery.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" name="image" required
                                            oninvalid="this.setCustomValidity('Masukan Gambar !')"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" required
                                    oninvalid="this.setCustomValidity('Masukan Judul!')" oninput="setCustomValidity('')">
                            </div>
