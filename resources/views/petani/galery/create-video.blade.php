...
@section('title', 'Tambah Galery Video')
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Tambah Galery Video</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title">Tambah Galery Video</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('petani.galery.store-video') }}" method="POST"
